...
<ul>
  ...
  <li>1/23/2023: Further hamburger work, device compatability work on Navbar (smaller screens now have the page links in the hamburger), addition of an About page to site and Figma, Figma work, Login and Signup designs complete, Footer added (needs to be stuck to bottom still)</li>
